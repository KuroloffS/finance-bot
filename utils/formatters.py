...
def format_daily_digest(total: float, n: int, top_cat: dict | None, lang: str, currency: str = DEFAULT_CURRENCY) -> str:
    if lang == "ru":
        head = "🌙 <b>Итоги дня</b>"
        if n == 0:
            return f"{head}\n{DIVIDER}\n\n💚 Сегодня ни одной траты — отличный день!"
