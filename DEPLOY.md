...
```
! railway variables --set "TELEGRAM_BOT_TOKEN=..." --set "GROQ_API_KEY=..." --set "SUPABASE_URL=https://ldttcomjzlyyeolblxry.supabase.co" --set "SUPABASE_SERVICE_KEY=..." --set "DEFAULT_CURRENCY=UZS" --set "DEFAULT_LANGUAGE=ru"
```
